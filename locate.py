...
def locate(img, unet):
    ...
    contours, _ = cv2.findContours(binary[:, :, 0], cv2.RETR_EXTERNAL,
    ...
    if len(contours) != 1:
        ...
        contours, _ = cv2.findContours(final_img[:, :, 0], cv2.RETR_EXTERNAL,
                                       cv2.CHAIN_APPROX_SIMPLE)
...
if __name__ == '__main__':
    ...
    unet = models.load_model('weights/locate.h5')
